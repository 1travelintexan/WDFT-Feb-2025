...
function AddBeerPage() {
  ...
  async function handleAddNewBeer(event) {
    ...
    // console.log("here is the beer being sent to the api", theBeerToAdd);
    // fetch("https://ih-beers-api2.herokuapp.com/beers/new", {
    //   method: "POST",
    //   headers: {
    //     "Content-Type": "application/json",
    //   },
    //   body: JSON.stringify(theBeerToAdd),
    // })
    //   .then((res) => res.json())
    //   .then((data) => {
    //     console.log("here is the newly added beer", data);
    //   })
    //   .catch((err) => console.log(err));

    //************post with axios **********/
    axios
      .post("https://ih-beers-api2.herokuapp.com/beers/new", theBeerToAdd)
      .then((res) => {
